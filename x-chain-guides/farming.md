...
To farm, you need LP tokens, which means you need to provide liquidity initially for the corresponding pool. To provide liquidity, please refer to the [Pooling section](../near-chain-guides/how-rhea-finance-works/pooling.md).&#x20;
